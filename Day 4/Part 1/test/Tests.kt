...
class TestDay4Part1 {
    ...
    fun testInput07_2_boards_3x3() {
        ...
        assertSolutionWorks("07", 924, "2", "14", input)
    }

    @Test
    fun testInput07_3_boards_3x3() {
        val input = arrayOf(
        ...
        assertSolutionWorks("08", 36, "3", "2", input)
    }


    @Test
    fun testInput09_sample_input_3_boards_5x5() {
        val input = arrayOf(
        ...
        assertSolutionWorks("09", 4512, "3", "24", input)
    }
